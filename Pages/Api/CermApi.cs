...
{
    public class CermApi
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly ILogger<FinishingTypesModel> _logger;

        public CermApi(IConfiguration configuration, IHttpClientFactory httpClientFactory, ILogger<FinishingTypesModel> logger)
        {
        ...
        public async Task<IActionResult> OnGetApiResultsAsync(IConfiguration ApiRequestUrl)
        {
            try
            {
        ...
        private async Task<object> FetchAPIResultsAsync(string materialsUrl, string accessToken)
        {
            try
            {
        ...
        internal static async Task OnGetApiResultAsync(string v)
        {
